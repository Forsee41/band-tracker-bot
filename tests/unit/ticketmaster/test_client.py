...
from band_tracker.ticketmaster.temp_const import ARTISTS, EVENTS


class TestClient:
    def test_get_artist_1(self) -> None:
        raw_artist = ARTISTS.get("_embedded").get("attractions")[0]
        artist = Artist(
            id="K8vZ9171RCf",
            name="The Orb",
        ...
        assert get_artist(raw_artist) == artist

    def test_get_artist_2(self) -> None:
        raw_artist = ARTISTS.get("_embedded").get("attractions")[1]
        artist = Artist(
            id="K8vZ9171OI0",
